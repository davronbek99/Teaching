...
import com.example.newentranttest.extensions.SingleBlock
import com.example.teaching.R
import com.example.teaching.databinding.LayoutExitBinding

class BaseDialog(val title: String, val text_cancel: String, val text_done: String) :
    DialogFragment() {
